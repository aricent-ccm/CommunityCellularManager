# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-05-18 10:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'default_permissions': (),
                'permissions': (('view_bts', 'View BTS(Tower)'), ('add_bts', 'Add BTS(Tower)'), ('change_bts', 'Change BTS(Tower)'), ('deregister_bts', 'Deregister BTS(Tower)')),
            },
        ),
        migrations.CreateModel(
            name='BTSLogfile',
        ...
        migrations.CreateModel(
            ...
            options={
                'default_permissions': (),
                'permissions': (('view_network', 'View network'), ('change_network', 'Change network')),
            },
        ),
        migrations.CreateModel(
            name='NetworkDenominaton',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            options={
                'default_permissions': (),
                'permissions': (('view_subscriber', 'View subscriber list'), ('change_subscriber', 'Edit subscriber'), ('deactive_subscriber', 'Deactive subscriber')),
            },
        ),
        migrations.CreateModel(
            name='SystemEvent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('credit', 'credit'), ('outside_sms', 'outside_sms'), ('outside_call', 'outside_call'), ('incoming_sms', 'incoming_sms'), ('incoming_call', 'incoming_call'), ('local_sms', 'local_sms'), ('local_call', 'local_call'), ('local_recv_call', 'local_recv_call'), ('local_recv_sms', 'local_recv_sms'), ('number.nexmo.monthly', 'number.nexmo.monthly')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            options={
                'default_permissions': (),
                'permissions': (('view_usage', 'View usage activities'), ('download_usage', 'Download usage activities')),
            },
        ),
        migrations.CreateModel(
            name='UserProfile',
            fields=[
                ...
                ('role', models.CharField(default='cloud_admin', max_length=20)),
